...
import com.inventory.controller.ManagementController;
import com.inventory.model._MappingKit;
...
public class MainConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		...
		me.add("/management", ManagementController.class);			// 第三个参数省略时默认与第一个参数值相同，在此即为 "/blog"
